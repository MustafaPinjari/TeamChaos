...
const lines = [
  { text: "I participated in 25+ hackathons.", size: "text-3xl md:text-5xl", weight: "font-black", color: "text-white" },
  { text: "Lost every single one.", size: "text-2xl md:text-4xl", weight: "font-bold", color: "text-white/60" },
  { text: "Each loss taught us something.", size: "text-xl md:text-3xl", weight: "font-semibold", color: "text-white/50" },
...
export default function TurningPoint() {
  ...
  return (
    <section className="py-40 px-6 relative overflow-hidden">
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[400px] h-[600px] bg-purple-600/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-24">
          <motion.blockquote
            ...
            className="glass rounded-2xl p-8 border border-purple-500/20 relative"
          >
